  ...
  <div style={{ fontSize: 13.5, color: "var(--ncu-ink)", lineHeight: 1.6 }}>
    ...
    >
      ...
      <ol style={{ margin: 0, paddingLeft: 20, color: "var(--ncu-ink)", fontSize: 13 }}>
        ...
        <li>
          在課務系統任何頁面<strong>點擊該書籤</strong>，將自動抓取並帶回學分試算！
        </li>
      </ol>
    </div>
    ...
    >
      <IonIcon icon={shieldCheckmarkOutline} style={{ fontSize: 14, color: "var(--ncu-success)" }} />
      <span>資料僅於瀏覽器本地處理，零伺服器傳輸，保障隱私安全。</span>
    </div>
  </div>
);
