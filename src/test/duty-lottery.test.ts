...
describe("Duty Lottery Utilities", () => {
  it("should extract all 73 duty candidates across 4 rooms", () => {
    const all = getAllDutyCandidates();
  ...
  it("should return empty array when all candidates are excluded and allowDuplicate is false", () => {
    const pool = getRoomDutyCandidates("919");
